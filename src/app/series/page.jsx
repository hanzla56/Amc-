            ...
            <div className={`h-screen back_img`}
                ...
                <div className='max-w-[1150px] 2xl:max-w-[1550px] mx-auto '>
                    ...
                    <div className='py-10 flex flex-col gap-5'>
                        <div>
                            <img src={logo.src} className='logo_center' alt="image" />
                        </div>
                        <Link href={"/"}> <Button variant="outlined" color="inherit" className="btnadd">
                                <IoIosArrowBack /> Back
                            </Button></Link>
                    </div>
                    <div className="absolute bottom-10 2xl:bottom-20 left-0 mx-auto right-0 z-10 max-w-[1150px] 2xl:max-w-[1550px] mange_container">
                        <Button
                            variant="contained"
                            className="btnadd"
