...
import heroimg from "@/assets/sld2.png"
    ...
    return (
        <>
            <div className={`h-screen back_img`}
                style={{ background: `linear-gradient(358.93deg, #0D0C0F 0.83%, rgba(13, 12, 15, 0.85) 28.55%, rgba(13, 12, 15, 0) 48.81%, rgba(13, 12, 15, 0.284314) 70.66%, #0D0C0F 103.18%),url(${heroimg.src})` }}>
                <div className='max-w-[1150px] 2xl:max-w-[1550px] mx-auto '>
                    ...
                    <div
                        ...
                        <h1 className="text-[32px] font-bold mt-2">Guardians of the Galaxy Vol. 3</h1>
                        <p className="2xl:text-[14px] text-[14px] mb-2">2h40m • 2022 • Fantasy • Actions</p>
            ...
            <TopCost/>
            <TabComponent tabs={["Trending ","More Like This","Trailers & More"]}/>
